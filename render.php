<?php
	...
	// Header/Entête
	$render = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\"
...
<head>
	...
	<link href=\"http$https://$host/behavior.css\" rel=\"stylesheet\" type=\"text/css\" />":"")."".(($isie5||$isie6||$isie7)?"
	...
	<table id=\"header\" cellpadding=\"0px\" cellspacing=\"0px\" width=\"100%\"><tr><td align=\"center\">
		<center>
			<table cellpadding=\"0px\" cellspacing=\"0px\"><tr><td align=\"right\">
				".($ismdx?"":"<img src=\"http$https://$host/img/gif/".(($lang == "fr") ? "Carrouciel" : "Carousoft").".gif\" alt=\"".(($lang == "fr") ? "Carrouciel" : "Carousoft")."\" border=\"0\" width=\"".(($lang == "fr") ? "276" : "262")."px\" height=\"45px\" /><br />")."
